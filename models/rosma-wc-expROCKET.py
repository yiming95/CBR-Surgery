...
####
parser = argparse.ArgumentParser(description='ROSMA Wire Chaser ROCKET')
parser.add_argument('--validation_option', type=str, default='LOSO1', help='Cross Validation Options')
args = parser.parse_args()

print("*** ROSMA Wire Chaser ROCKET ***  " + (args.validation_option) )
...
# file_name = f"rocket_wc_multimodality_{validation_option}.csv"
...
####
file_path = './results/rosma/' + "rocket_wc_" + str(args.validation_option) + '_results.csv'
df.to_csv(file_path, index=False)
...
####
np.save('./results/rosma/' + "./rocket_wc_" + str(args.validation_option) + "_train_feature_vectors.npy", train_transformed)
np.save('./results/rosma/' + "./rocket_wc_" + str(args.validation_option) + "_validation_feature_vectors.npy", validation_transformed)
np.save('./results/rosma/' + "./rocket_wc_" + str(args.validation_option) + "_test_feature_vectors.npy", test_transformed)