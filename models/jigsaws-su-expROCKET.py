...
parser = argparse.ArgumentParser(description='JIGSAWS Suturing ROCKET')
parser.add_argument('--validation_option', type=str, default='LOSO1', help='Cross Validation Options')
args = parser.parse_args()

print("*** JIGSAWS Suturing ROCKET ***  " + (args.validation_option) )
...
file_path = './results/jigsaws/' + "rocket_su_" + str(args.validation_option) + '_results.csv'
...
np.save('./results/jigsaws/' + "./rocket_su_" + str(args.validation_option) + "_train_feature_vectors.npy", train_transformed)
np.save('./results/jigsaws/' + "./rocket_su_" + str(args.validation_option) + "_validation_feature_vectors.npy", validation_transformed)
np.save('./results/jigsaws/' + "./rocket_su_" + str(args.validation_option) + "_test_feature_vectors.npy", test_transformed)
